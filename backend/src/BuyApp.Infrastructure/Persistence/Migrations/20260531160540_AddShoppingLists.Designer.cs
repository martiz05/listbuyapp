...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BuyApp.Domain.ShoppingLists.ShoppingList", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("BuyApp.Domain.ShoppingLists.ShoppingListItem", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("BuyApp.Infrastructure.Identity.ApplicationUser", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("BuyApp.Domain.ShoppingLists.ShoppingListItem", b =>
                {
                    b.HasOne("BuyApp.Domain.ShoppingLists.ShoppingList", null)
                        .WithMany("Items")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<System.Guid>", b =>
                {
                    b.HasOne("BuyApp.Infrastructure.Identity.ApplicationUser", null)
                        .WithMany()
